...
- [x] 일정 상세 정보 API
- [x] 통합 테스트 작성 (test_schedules.py)

**예상 기간**: 1주
**담당자**: Claude + eommji@gmail.com
**완료 상태**: 80% (월/목 자동 생성 미구현)
**비고**: 정기런 자동 생성은 Phase 5 스케줄러와 함께 구현 예정

---

### **Phase 5: 규칙 자동화 시스템**
- [ ] 일정 개설 조건 검증
  - [ ] 최근 6개월 내 러닝 일정 3회 이상 참석 확인
- [ ] 일정 참여 제한 규칙
  - [ ] 러닝 일정: 누구나 참여 가능
  - [ ] 대회/비러닝: 러닝 3회 이상 참석자만 참여
- [ ] 강퇴 조건 자동 판별
  - [ ] 노쇼 2회 이상 감지 및 상태 변경
- [ ] 규칙 자동 실행 스케줄러 구현
- [ ] 규칙 적용 로그 기록
...
**예상 기간**: 2주
**담당자**: Claude + eommji@gmail.com
**완료 상태**: 30% (핵심 출석표 화면 완성, 통계/규칙 설정 미구현)
